...
<img width="713" height="657" alt="Screenshot 2026-09-01 203717" src="https://github.com/user-attachments/assets/cedf6c29-31f8-4664-8b74-722f0e0d11c7" />
...
### ER Diagram:
*Paste or attach your diagram here*  
<img width="716" height="642" alt="image" src="https://github.com/user-attachments/assets/4dca447d-5ca1-4c0a-84e0-a4b94f4a2522" />
...
| Registration  | MemberID (FK, PK), EventID (FK, PK), RegistrationDate                 | Links members to events                  |
| EventSpeaker  | EventID (FK, PK), SpeakerID (FK, PK)                                  | Links events to speakers                 |
| EventRoom     | EventID (FK, PK), RoomID (FK, PK), BookingDate     
### Assumptions
...
### ER Diagram:
*Paste or attach your diagram here*  
<img width="711" height="570" alt="image" src="https://github.com/user-attachments/assets/ae2c8ff7-5f97-4516-8425-cf612bd28955" />
...
| OrderLine    | OrderID (FK, PK), DishID (FK, PK), Quantity, Subtotal  
### Relationships and Constraints
...
| Reservation PLACES Order             | 1:N                                         | Total (Order), Partial (Reservation)       | Each order is linked to one reservation; a reservation can 
